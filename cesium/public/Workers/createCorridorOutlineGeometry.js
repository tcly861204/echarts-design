define([
...
], function (e, t, i, r, o, n, s, a, l, d, u, p, f, c, h, y, g, b, m, A, _, E, C) {
  'use strict'
  ...
  function v(e, t) {
    ...
    for (g = 0; g < o.length; g += 2)
      (b = o[g].length - 3), (m += b), (_ += (b / 3) * 4), (A += o[g + 1].length - 3)
    ...
    let M = 0,
      ...
      U = o[M++]
    for (
      w.set(R, N), w.set(U, O - U.length + 1), b = U.length - 3, i.push(N / 3, (O - 2) / 3), g = 0;
      g < b;
      g += 3
    )
      (D = N / 3),
  ...
  function w(e) {
    ...
    ;(this._positions = t),
      ...
      (this._granularity = l.defaultValue(e.granularity, n.CesiumMath.RADIANS_PER_DEGREE)),
  ...
  w.pack = function (e, t, i) {
    ...
    const o = e._positions,
      n = o.length
    t[i++] = n
    for (let e = 0; e < n; ++e, i += r.Cartesian3.packedLength) r.Cartesian3.pack(o[e], t, i)
    return (
  ...
  return (
    (w.unpack = function (e, t, i) {
      ...
      const o = e[t++],
        n = new Array(o)
      for (let i = 0; i < o; ++i, t += r.Cartesian3.packedLength) n[i] = r.Cartesian3.unpack(e, t)
    ...
    (w.createGeometry = function (o) {
      ...
      if (b)
        (m.height = y),
          ...
          (A = (function (t) {
            const i = t.ellipsoid,
              r = v(a.CorridorGeometryLibrary.computePositions(t), t.cornerType),
              o = r.wallIndices,
              s = t.height,
              u = t.extrudedHeight,
              c = r.attributes,
            ...
            if (
              ...
              if (t.offsetAttribute === e.GeometryOffsetAttribute.TOP) i = e.arrayFill(i, 1, 0, g)
              else {
                const r = t.offsetAttribute === e.GeometryOffsetAttribute.NONE ? 0 : 1
                i = e.arrayFill(i, r)
              }
            ...
            let A
            const _ = h.length,
              E = p.IndexDatatype.createTypedArray(m.length / 3, 2 * (_ + o.length))
            E.set(h)
            let C,
              G,
              T = _
        ...
        if (
          ...
          (A.attributes.position.values = f.PolygonPipeline.scaleToGeodeticHeight(
