define([
...
], function (t, e, r, a, i, o, n, s, l, d, u, c, m, y, f, p, g, h, b, C, A, _, w, v) {
  'use strict'
  ...
  function M(t, e, r) {
    ...
    if (w) {
      ...
      const t = m[0]
      for (
        U = a.Cartesian3.fromArray(f, 0, U), Y = a.Cartesian3.fromArray(y, 0, Y), h = 0;
        h < W;
        h++
      )
    ...
    for (
      ...
      if (((U = a.Cartesian3.fromArray(f, X, U)), l.defined(o))) {
        for (D(M, U, Y, void 0, B, e), B -= 3, u = R, c = S, t = 0; t < o.length / 3; t++)
        ...
        ;(m = a.Cartesian3.fromArray(N, 3 * u, m)),
          (p = a.Cartesian3.subtract(a.Cartesian3.fromArray(N, 3 * c, p), m, p)),
          (C = a.Cartesian3.subtract(a.Cartesian3.fromArray(N, 3 * (c - t), C), m, C)),
          (Y = a.Cartesian3.normalize(a.Cartesian3.add(p, C, Y), Y)),
          D(M, U, Y, z, void 0, e),
          (z += 3)
      } else {
        for (D(M, U, Y, z, void 0, e), z += 3, u = S, c = R, t = 0; t < d.length / 3; t++)
          (m = a.Cartesian3.fromArray(d, 3 * t, m)),
            ...
            (z += 3)
        ;(m = a.Cartesian3.fromArray(N, 3 * u, m)),
          (p = a.Cartesian3.subtract(a.Cartesian3.fromArray(N, 3 * (c + t), p), m, p)),
          (C = a.Cartesian3.subtract(a.Cartesian3.fromArray(N, 3 * c, C), m, C)),
          (Y = a.Cartesian3.normalize(a.Cartesian3.negate(a.Cartesian3.add(C, p, Y), Y), Y)),
          D(M, U, Y, void 0, B, e),
          (B -= 3)
      }
      for (
    ...
    if (((U = a.Cartesian3.fromArray(f, f.length - 3, U)), D(M, U, Y, z, B, e), w)) {
      ;(z += 3), (B -= 3), (H = E), (k = V)
      const t = m[1]
      for (h = 0; h < W; h++)
    ...
    if (
      ...
      if (w) {
        ...
        for (C /= 3, A /= 3, r = 1 / (C - 1), e = 1 / (A - 1), h = 0; h < A; h++)
          (t[a++] = h * e), (t[a++] = 0)
  ...
  function I(e, r) {
    ...
    ;(b = m.PolygonPipeline.scaleToGeodeticHeight(b, f, n)),
      ...
      (g = (function (t, e) {
        ...
        let i, o
        ;(e.normal || e.bitangent) && ((i = t.normal.values), (o = t.bitangent.values))
        ...
        if (e.normal || e.bitangent || e.tangent) {
          ...
          if (e.normal) {
            for (n.set(i), c = 0; c < l; c += 3)
              (n[c + l] = -i[c]), (n[c + l + 1] = -i[c + 1]), (n[c + l + 2] = -i[c + 2])
            t.normal.values = n
  ...
  q.pack = function (t, e, r) {
    ...
    const i = t._positions,
      o = i.length
    e[r++] = o
    for (let t = 0; t < o; ++t, r += a.Cartesian3.packedLength) a.Cartesian3.pack(i[t], e, r)
    return (
  ...
  return (
    (q.unpack = function (t, e, r) {
      ...
      const i = t[e++],
        o = new Array(i)
      for (let r = 0; r < i; ++r, e += a.Cartesian3.packedLength) o[r] = a.Cartesian3.unpack(t, e)
    ...
    (q.createGeometry = function (i) {
      ...
      if (g)
        ...
        if (
          ...
          (C.attributes.position.values = m.PolygonPipeline.scaleToGeodeticHeight(
          ...
          const e = i._offsetAttribute === t.GeometryOffsetAttribute.NONE ? 0 : 1,
