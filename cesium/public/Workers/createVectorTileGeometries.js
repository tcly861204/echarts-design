define([
  ...
  function A(e, t) {
    ...
    return n.Cartesian3.clone(n.Cartesian3.ZERO, o.center), (o.radius = Math.sqrt(3)), w
  }
  function O(e, t) {
    let r = t * k
    const a = e[r++],
    ...
    return n.Cartesian3.clone(n.Cartesian3.ZERO, c.center), (c.radius = Math.sqrt(2)), w
  }
  function L(e, t) {
    let r = t * M
    const a = n.Cartesian3.unpack(e, r, C)
  ...
  function U(t, a, o, s, c) {
    ...
    for (let t = 0; t < d; ++t) {
      ...
      const U = t + O
      ;(x[U] = new m({ offset: A, count: v, color: r.Color.fromRgba(y[d]), batchIds: [d] })),
        (p[U] = d),
        (g[U] = A),
        (C[U] = v),
  ...
  return c(function (e, r) {
    const c = i.defined(e.boxes) ? new Float32Array(e.boxes) : void 0,
      ...
      f = i.defined(e.cylinderBatchIds) ? new Uint16Array(e.cylinderBatchIds) : void 0,
    ...
    !(function (e) {
      ...
      let r = 0
      n.Cartesian3.unpack(t, r, G), (r += n.Cartesian3.packedLength), n.Matrix4.unpack(t, r, S)
    })(e.packedBuffer)
    const z = {
