  ...
  return (
    ...
    (v.createGeometry = function (a) {
      ...
      for (P = 0; P < v; ++P) {
        ...
        if (
          ...
          if ((P + 1 < v && (a = t.Cartesian3.fromArray(h, e + 3, _)), W)) {
            ...
            ;(I = t.Cartesian3.normalize(t.Cartesian3.cross(i, e, I), I)), (W = !1)
          }
          t.Cartesian3.equalsEpsilon(n, a, i.CesiumMath.EPSILON10)
            ? (W = !0)
            : ((B += U),
              c.tangent && (N = t.Cartesian3.normalize(t.Cartesian3.subtract(a, n, N), N)),
              c.bitangent && (M = t.Cartesian3.normalize(t.Cartesian3.cross(I, N, M), M))),
            c.normal &&
              ((V[z++] = I.x),
              (V[z++] = I.y),
              (V[z++] = I.z),
      ...
      for (P = 0; P < J - 2; P += 2) {
        ...
        const r = P + 1,
          s = P + 3
        ;(Y[j++] = r), (Y[j++] = e), (Y[j++] = s), (Y[j++] = s), (Y[j++] = e), (Y[j++] = n)
      }
