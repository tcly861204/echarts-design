  ...
  return (
    (E.createGeometry = function (t) {
      const a = t._rectangle,
        l = t._ellipsoid,
        p = c.RectangleGeometryLibrary.computeOptions(a, t._granularity, t._rotation, 0, b, P)
      let d, f
      if (
      ...
      if (!o.CesiumMath.equalsEpsilon(g, m, 0, o.CesiumMath.EPSILON2)) {
        if (
          ((d = (function (e, t) {
            const i = e._surfaceHeight,
              ...
              c = t.height,
              p = t.width,
              d = u.PolygonPipeline.scaleToGeodeticHeight(l.attributes.position.values, r, o, !1)
            let f = d.length
            const g = new Float64Array(2 * f)
            g.set(d)
            const h = u.PolygonPipeline.scaleToGeodeticHeight(l.attributes.position.values, a, o)
            ...
            let G,
              R = 0
            for (let e = 0; e < f - 1; e++)
              (A[R++] = e), (A[R++] = e + 1), (A[R++] = e + f), (A[R++] = e + f + 1)
            if (
              ((A[R++] = f - 1),
              (A[R++] = 0),
              (A[R++] = f + f - 1),
        ...
        if (
          ((d = _(t, p)),
          (d.attributes.position.values = u.PolygonPipeline.scaleToGeodeticHeight(
