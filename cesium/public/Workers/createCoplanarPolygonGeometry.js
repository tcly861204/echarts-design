define([
...
], function (e, t, n, o, a, r, i, s, l, c, p, y, u, m, d, g, b, f, h, x, C, P, A, w, F, G, L, E) {
  'use strict'
  ...
  function N(e, t, a, i, s, p, y, m) {
    ...
    if (0 !== i) {
      ...
      if (((h = o.Matrix3.fromQuaternion(e, h)), t.tangent || t.bitangent)) {
        ...
        ;(y = o.Cartesian3.normalize(o.Matrix3.multiplyByVector(a, y, y), y)),
          t.bitangent && (m = o.Cartesian3.normalize(o.Cartesian3.cross(p, y, m), m))
      }
    ...
    return (
      ...
      new l.Geometry({ attributes: I, indices: f, primitiveType: l.PrimitiveType.TRIANGLES })
    )
  }
  function Q(e) {
    ...
    ;(this._vertexFormat = g.VertexFormat.clone(n)),
      ...
      (this._ellipsoid = o.Ellipsoid.clone(s.defaultValue(e.ellipsoid, o.Ellipsoid.WGS84))),
  ...
  ;(Q.fromPositions = function (e) {
    ...
    (Q.pack = function (e, t, n) {
      return (
        ...
        (n = m.PolygonGeometryLibrary.packPolygonHierarchy(e._polygonHierarchy, t, n)),
  ...
  return (
    ...
    (Q.createGeometry = function (t) {
      const a = t._vertexFormat,
        ...
        c = t._stRotation
      let d = s.positions
      if (((d = e.arrayRemoveDuplicates(d, o.Cartesian3.equalsEpsilon, !0)), d.length < 3)) return
      let g = V,
        b = k,
        f = R,
        h = M
      const x = B
      if (!i.CoplanarPolygonGeometryLibrary.computeProjectTo2DArguments(d, I, h, x)) return
      if (
        ((g = o.Cartesian3.cross(h, x, g)),
        (g = o.Cartesian3.normalize(g, g)),
        !o.Cartesian3.equalsEpsilon(I, o.Cartesian3.ZERO, r.CesiumMath.EPSILON6))
      ) {
        const e = t._ellipsoid.geodeticSurfaceNormal(I, S)
        o.Cartesian3.dot(g, e) < 0 &&
          ((g = o.Cartesian3.negate(g, g)), (h = o.Cartesian3.negate(h, h)))
      }
      const C = i.CoplanarPolygonGeometryLibrary.createProjectPointsTo2DFunction(I, h, x),
        P = i.CoplanarPolygonGeometryLibrary.createProjectPointTo2DFunction(I, h, x)
      a.tangent && (b = o.Cartesian3.clone(h, b)), a.bitangent && (f = o.Cartesian3.clone(x, f))
      ...
      for (let e = 0; e < F.length; e++) {
        const t = new p.GeometryInstance({ geometry: N(F[e], a, L, c, P, g, b, f) })
        E.push(t)
      }
      const v = y.GeometryPipeline.combineInstances(E)[0]
      ;(v.attributes.position.values = new Float64Array(v.attributes.position.values)),
