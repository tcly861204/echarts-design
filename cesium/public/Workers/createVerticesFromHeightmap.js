define([
  ...
  './Plane-3f01019d',
], function (e, t, i, a, n, r, s, l, o, f, u, c, d, h, m, g, p) {
  'use strict'
  var x = Object.freeze({ NONE: 0, LERC: 1 })
  const w = {}
  w.DEFAULT_STRUCTURE = Object.freeze({
    heightScale: 1,
    heightOffset: 0,
    elementsPerHeight: 1,
    stride: 1,
  ...
  const k = new e.Cartesian3(),
    y = new e.Matrix4(),
    I = new e.Cartesian3(),
    b = new e.Cartesian3()
  w.computeVertices = function (n) {
    const f = Math.cos,
      u = Math.sin,
      c = Math.sqrt,
      d = Math.atan,
      h = Math.exp,
      m = s.CesiumMath.PI_OVER_TWO,
      g = s.CesiumMath.toRadians,
      p = n.heightmap,
      x = n.width,
      U = n.height,
      T = n.skirtHeight,
      M = T > 0,
      V = a.defaultValue(n.isGeographic, !0),
      v = a.defaultValue(n.ellipsoid, e.Ellipsoid.WGS84),
      A = 1 / v.maximumRadius,
      B = e.Rectangle.clone(n.nativeRectangle),
      D = e.Rectangle.clone(n.rectangle)
    let S, P, E, C
    a.defined(D)
      ? ((S = D.west), (P = D.south), (E = D.east), (C = D.north))
      : V
      ? ((S = g(B.west)), (P = g(B.south)), (E = g(B.east)), (C = g(B.north)))
      : ((S = B.west * A),
        (P = m - 2 * d(h(-B.south * A))),
        (E = B.east * A),
        (C = m - 2 * d(h(-B.north * A))))
    let F = n.relativeToCenter
    const N = a.defined(F)
    F = N ? F : e.Cartesian3.ZERO
    const O = a.defaultValue(n.includeWebMercatorT, !1),
      R = a.defaultValue(n.exaggeration, 1),
      L = a.defaultValue(n.exaggerationRelativeHeight, 0),
      z = 1 !== R,
      H = a.defaultValue(n.structure, w.DEFAULT_STRUCTURE),
      _ = a.defaultValue(H.heightScale, w.DEFAULT_STRUCTURE.heightScale),
      Y = a.defaultValue(H.heightOffset, w.DEFAULT_STRUCTURE.heightOffset),
      W = a.defaultValue(H.elementsPerHeight, w.DEFAULT_STRUCTURE.elementsPerHeight),
      X = a.defaultValue(H.stride, w.DEFAULT_STRUCTURE.stride),
      Z = a.defaultValue(H.elementMultiplier, w.DEFAULT_STRUCTURE.elementMultiplier),
      j = a.defaultValue(H.isBigEndian, w.DEFAULT_STRUCTURE.isBigEndian)
    let G = e.Rectangle.computeWidth(B),
      q = e.Rectangle.computeHeight(B)
    const Q = G / (x - 1),
      J = q / (U - 1)
    V || ((G *= A), (q *= A))
    const K = v.radiiSquared,
      $ = K.x,
      ee = K.y,
      te = K.z
    let ie = 65536,
      ae = -65536
    const ne = i.Transforms.eastNorthUpToFixedFrame(F, v),
      re = e.Matrix4.inverseTransformation(ne, y)
    let se, le
    O &&
      ((se = o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(P)),
      (le = 1 / (o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(C) - se)))
    const oe = I
    ...
    let ue = Number.POSITIVE_INFINITY
    const ce = x * U,
      de = ce + (T > 0 ? 2 * x + 2 * U : 0),
      he = new Array(de),
      me = new Array(de),
    ...
    for (let t = we; t < ke; ++t) {
      ...
      a = V ? g(a) : m - 2 * d(h(-a * A))
      let n = (a - P) / (C - P)
      n = s.CesiumMath.clamp(n, 0, 1)
      const r = t === we,
        l = t === ke - 1
      T > 0 && (r ? (a += be * q) : l && (a -= be * q))
      const w = f(a),
        y = u(a),
        I = te * y
      let b
      O && (b = (o.WebMercatorProjection.geodeticLatitudeToMercatorAngle(a) - se) * le)
      for (let t = ye; t < Ie; ++t) {
        let a = t
        a < 0 && (a = 0), a >= x && (a = x - 1)
        const o = i * (x * X) + a * X
        ...
        if (1 === W) d = p[o]
          ...
          let e
          if (((d = 0), j)) for (e = 0; e < W; ++e) d = d * Z + p[o + e]
          else for (e = W - 1; e >= 0; --e) d = d * Z + p[o + e]
        }
        ;(d = d * _ + Y), (ae = Math.max(ae, d)), (ie = Math.min(ie, d))
        let h = B.west + Q * a
        V ? (h = g(h)) : (h *= A)
        let m = (h - S) / (E - S)
        m = s.CesiumMath.clamp(m, 0, 1)
        let M = i * x + a
        if (T > 0) {
          const e = t === ye,
            n = t === Ie - 1,
        ...
        ;(q.x = R + D * d),
          (q.y = L + P * d),
          (q.z = H + y * d),
          e.Matrix4.multiplyByPoint(re, q, k),
          e.Cartesian3.minimumByComponent(k, oe, oe),
          e.Cartesian3.maximumByComponent(k, fe, fe),
          (ue = Math.min(ue, d)),
          (he[M] = q),
          (ge[M] = new e.Cartesian2(m, n)),
          (me[M] = d),
          O && (pe[M] = b),
          z && (xe[M] = v.geodeticSurfaceNormal(q))
      }
    }
    const Ue = i.BoundingSphere.fromPoints(he)
    let Te, Me
    if ((a.defined(D) && (Te = l.OrientedBoundingBox.fromRectangle(D, ie, ae, v)), N)) {
      Me = new r.EllipsoidalOccluder(v).computeHorizonCullingPointPossiblyUnderEllipsoid(F, he, ie)
    }
    const Ve = new t.AxisAlignedBoundingBox(oe, fe, F),
      ve = new r.TerrainEncoding(F, Ve, ue, ae, ne, !1, O, z, R, L),
      Ae = new Float32Array(de * ve.stride)
    let Be = 0
    for (let e = 0; e < de; ++e) Be = ve.encode(Ae, Be, he[e], ge[e], me[e], void 0, pe[e], xe[e])
    return {
      vertices: Ae,
      maximumHeight: ae,
      minimumHeight: ie,
  ...
  var U = f.createCommonjsModule(function (e) {
          ...
          ((t = {
            ...
            decode: function (e, s) {
              var l = (s = s || {}).encodedMaskData || null === s.encodedMaskData,
                o = r(e, s.inputOffset || 0, l),
                f = null !== s.noDataValue ? s.noDataValue : t.defaultNoDataValue,
                u = i(o, s.pixelType || Float32Array, s.encodedMaskData, f, s.returnMask),
                c = {
                  width: o.width,
                  height: o.height,
              ...
              return (
                ...
                s.returnFileInfo &&
                  ((c.fileInfo = a(o)), s.computeUsedBitDepths && (c.fileInfo.bitDepths = n(o))),
                c
              )
            },
          }),
                ...
                for (var I = 0; I <= u; I++) {
                  ...
                  if (0 !== b) {
                    ...
                    if (
                      ...
                      for (x = 0; x < y; x++) {
                        for (p = 0; p < b; p++) (g = g > (r = U[T++]) ? r : g), (l[v++] = r)
                        v += A
                      }
                    else
                      for (g = g > M ? M : g, x = 0; x < y; x++) {
                        for (p = 0; p < b; p++) l[v++] = M
                        v += A
                      }
                    if (1 === B.encoding && T !== B.numValidPixels)
            ...
            if (
              ...
              if (
                ...
                0 == (a.mask.numBytes | a.mask.numBlocksY | a.mask.maxValue) &&
                  (a.mask.bitset = new Uint8Array(Math.ceil((a.width * a.height) / 8)))
            ;(r = new DataView(e, t, 16)),
              (a.pixels = {}),
                ...
                if (2 !== y.encoding) {
                  ...
                  if (((t += w), 3 !== y.encoding))
                    if (0 === y.encoding) {
                      ...
                      ;(b = new ArrayBuffer(4 * U)),
                        new Uint8Array(b).set(new Uint8Array(e, t, 4 * U))
          ...
          (h = {
            ...
            readHeaderInfo: function (e, t) {
              ...
              if (
                ...
                l >= 3 &&
                  ((r = l >= 4 ? 52 : 48),
                  this.computeChecksumFletcher32(new Uint8Array(e, i - r, n.blobSize - 14)) !==
                    n.checksum))
              )
            ...
            readMask: function (e, t) {
              ...
              if (0 === l)
                ...
                var m = 0,
                  g = 0
                for (g = 0; g < s; g++)
                  7 & g ? ((m = i[g >> 3]), (m <<= 7 & g)) : (m = i[g >> 3]), 128 & m && (a[g] = 1)
            ...
            readDataOneSweep: function (e, t, i) {
              var a,
                ...
                l = r.width * r.height,
                o = r.imageType,
                f = r.numValidPixel * h.getDataTypeSize(o) * s,
              ...
              if (a.length === l * s) t.pixels.resultPixels = a
                ...
                if (s > 1)
                  for (g = 0; g < s; g++)
                    for (p = g * l, m = 0; m < l; m++)
                      u[m] && (t.pixels.resultPixels[p + m] = a[d++])
                else for (m = 0; m < l; m++) u[m] && (t.pixels.resultPixels[m] = a[d++])
              }
            ...
            readHuffmanTree: function (e, t) {
              ...
              var o,
                ...
                d = []
              for (o = r; o < s; o++)
                d[(f = o - (o < n ? 0 : n))] = { first: l[o - r], second: null }
              ...
              var M,
                ...
                D = []
              for (o = r; o < s; o++)
                if ((c = d[(f = o - (o < n ? 0 : n))].first) > 0)
                  if (((M = [c, f]), c <= U))
                    for (V = d[f].second << (U - c), v = 1 << (U - c), u = 0; u < v; u++)
                      D[V | u] = M
                  else
                    for (V = d[f].second, B = T, A = c - 1; A >= 0; A--)
                      (V >>> A) & 1
                  ...
                  for (u = 0, o = 0; o < m; o++)
                    for (f = 0; f < g; f++, u++) {
                      if (
                        ...
                        for (
                          l = s = (B << b) >>> (32 - T),
                            32 - b < T && (l = s |= y[I + 1] >>> (64 - b - T)),
                            a = k,
                            c = 0;
                          c < T;
                          c++
                        )
                          if (!(a = (s >>> (T - c - 1)) & 1 ? a.right : a.left).left && !a.right) {
                            ;(n = a.val), (b = b + c + 1)
                            break
                          }
                      b >= 32 && ((b -= 32), (B = y[++I])),
                      ...
                      if (V[u]) {
                        if (
                          ...
                          for (
                            ...
                            if (
                              !(a = (s >>> (T - c - 1)) & 1 ? a.right : a.left).left &&
                              !a.right
                            ) {
                              ;(n = a.val), (b = b + c + 1)
                              break
              ...
              if (w) {
                for (
                  t.counter.lut++,
                    ...
                    U = new Uint8Array(b),
                    t.ptr += h,
                    U.set(new Uint8Array(e, t.ptr, T)),
                    v = new Uint32Array(b),
                    t.ptr += T,
                    B = 0;
                  (A - 1) >>> B;
                ...
                ;(T = Math.ceil((y * B) / 8)),
                  (M = Math.ceil(T / 4)),
                  (b = new ArrayBuffer(4 * M)),
                  (U = new Uint8Array(b)).set(new Uint8Array(e, t.ptr, T)),
                  (I = new Uint32Array(b)),
                  (t.ptr += T),
                  (V = s >= 3 ? u(v, k, A - 1, a, D, S) : o(v, k, A - 1, a, D, S)),
                  s >= 3 ? f(I, i, B, y, V) : l(I, i, B, y, V)
              } else
            ...
            readTiles: function (e, t, i) {
              ...
              for (b = 0; b < u; b++)
                for (T = b !== u - 1 ? s : N, U = 0; U < f; U++)
                  for (
                    B = b * n * s + U * s, D = n - (M = U !== f - 1 ? s : O), k = 0;
                    k < R;
                    k++
                  ) {
                    if (
                      ...
                      C++,
                      (A =
                        ((v = (c = new DataView(e, t.ptr, Math.min(10, V))).getUint8(0)) >> 6) &
                        255),
                      ((v >> 2) & 15) != (((U * s) >> 3) & 15))
                    )
                    ...
                    if (2 !== p)
                      if (0 === p) {
                        if (
                          ...
                          (t.ptr += C),
                          (S = (S = T * M * o) < (P = e.byteLength - t.ptr) ? S : P),
                          ...
                          for (y = 0; y < T; y++) {
                            for (I = 0; I < M; I++) L[B] && (z[B] = g[E++]), B++
                            B += D
                          }
                        else
                          for (y = 0; y < T; y++) {
                            for (I = 0; I < M; I++) z[B++] = g[E++]
                            B += D
                          }
                        t.ptr += E * o
                      } else if (
                        ...
                        for (y = 0; y < T; y++) {
                          for (I = 0; I < M; I++) L[B] && (z[B] = F[C++]), B++
                          B += D
                        }
                      else
                        for (y = 0; y < T; y++) {
                          for (I = 0; I < M; I++) z[B++] = F[C++]
                          B += D
                        }
            ...
            constructConstantSurface: function (e) {
              ...
              if (o)
                if (i > 1)
                  for (r = 0; r < i; r++)
                    for (l = r * a, s = 0; s < a; s++) o[s] && (e.pixels.resultPixels[l + s] = t)
          ...
          }),
          {
            decode: function (e, t) {
              var i = (t = t || {}).noDataValue,
                a = 0,
                n = {}
              ;(n.ptr = t.inputOffset || 0), (n.pixels = {}), h.readHeaderInfo(e, n)
              var r = n.headerInfo,
                s = r.fileVersion,
                l = h.getDataTypeArray(r.imageType)
              h.readMask(e, n),
              ...
              if (
                ...
                if (r.zMax === r.zMin) h.constructConstantSurface(n)
                else if (s >= 4 && h.checkMinMaxRanges(e, n)) h.constructConstantSurface(n)
                else {
                  var u = new DataView(e, n.ptr, 2),
                    c = u.getUint8(0)
                  if ((n.ptr++, c)) h.readDataOneSweep(e, n, l)
                  else if (s > 1 && r.imageType <= 1 && Math.abs(r.maxZError - 0.5) < 1e-5) {
                    var d = u.getUint8(1)
                    if ((n.ptr++, (n.encodeMode = d), d > 2 || (s < 4 && d > 1)))
                      throw 'Invalid Huffman flag ' + d
                    d ? h.readHuffman(e, n, l) : h.readTiles(e, n, l)
                  } else h.readTiles(e, n, l)
                }
              ;(n.eofOffset = n.ptr),
                t.inputOffset
                  ? ((o = n.headerInfo.blobSize + t.inputOffset - n.ptr),
                    Math.abs(o) >= 1 && (n.eofOffset = t.inputOffset + n.headerInfo.blobSize))
              ...
              if (n.pixels.resultMask && h.isValidPixelValue(r.imageType, i)) {
                var g = n.pixels.resultMask
                for (a = 0; a < f; a++) g[a] || (m.pixelData[a] = i)
                m.noDataValue = i
              }
              return (n.noDataValue = i), t.returnFileInfo && (m.fileInfo = h.formatFileInfo(n)), m
            },
            getBandCount: function (e) {
              for (var t = 0, i = 0, a = { ptr: 0, pixels: {} }; i < e.byteLength - 58; )
                h.readHeaderInfo(e, a), (i += a.headerInfo.blobSize), t++, (a.ptr = i)
              return t
            },
          }),
        k =
  ...
  return u(function (t, i) {
    if (t.encoding === x.LERC) {
      let e
      try {
        e = U.decode(t.heightmap)
      } catch (e) {
    ...
    const a = w.computeVertices(t),
      r = a.vertices
    return (
      i.push(r.buffer),
      {
        vertices: r.buffer,
        numberOfAttributes: a.encoding.stride,
